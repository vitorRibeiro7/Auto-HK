...
function Form({ initialValues, onSubmit, title, flag, onCancel, loading }: { initialValues: any, onSubmit: any, title: string, flag: boolean, onCancel: any, loading: boolean }) {
        ...
        <div className="w-full h-full flex flex-col items-center p-12 gap-12 bg-slate-50">
            ...
            <form className="w-full flex flex-col gap-10" onSubmit={formik.handleSubmit}>
                ...
                <div className="w-full flex flex-row justify-center gap-8">
                    <button type="submit" className="w-32 flex items-center justify-center bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
                        {loading
                            ?
                    ...
                    <button type="button" className="w-32 flex items-center justify-center bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" onClick={onCancel}>
                        Cancelar
                    </button>
                </div>
            </form >
